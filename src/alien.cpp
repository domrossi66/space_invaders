...
Alien::Alien(int type, Vector2 position)
{
    ...
    // Check if aliens types are initiliazed (array is all 0s if not)
    // Then we load an alien image to each index of the array
    ...
    switch (type)
    {
        ...
        case 3:
            ...
            break;
        default:
            alienImages[3] = LoadTexture("Graphics/alien_1.png");
            break;
    }
}
}
